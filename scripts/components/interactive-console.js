(function() {
  ...
  $(document).ready(function() {
    ...
    $(window).on('resize', function() {
      showUserApiKeySessionStorage(true);
    } );
    ...
    loggedUserKeyContainer.on('click', '.copy-btn', function() {
      let copyBtn = this;
      let content = copyBtn.dataset !== undefined ? this.dataset.clipboardText : copyBtn.getAttribute('data-clipboard-text');

      if (window.clipboardData) {
        window.clipboardData.setData('Text', content);
      } else {
        // create a temporary element for the execCommand method
        let forExecElement = CreateElementForExecCommand(content);
