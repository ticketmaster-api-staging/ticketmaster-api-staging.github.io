$(document).ready(function() {
          ...
          .each(function() {
            ...
            screenBtn.addEventListener('click', function() {
              if ($(this).parent().parent().prev().hasClass('window-title')) {
                let title = $(this).parent().parent().prev()
                  .clone(true)
                  .find('a')
                  .remove()
                  .end()
            ...
            rawBtn.addEventListener('click', function() {
              ...
              let win = window.open(window.location.protocol + '//' + window.location.host + '/products-and-docs/tutorials/raw-view/', '_blank');
              win.focus();
            });
  ...
  $('.t-lang-selector a').click(function(event) {
    ...
    let buttonsGroup = currentButton.parent().find('a');
    let tabsGroup = currentButton.parent().parent().parent().find('.tab-content');
